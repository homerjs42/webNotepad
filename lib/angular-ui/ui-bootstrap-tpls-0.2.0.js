...
dialogModule.provider("$dialog", function(){
  ...
  function ($http, $document, $compile, $rootScope, $controller, $templateCache, $q, $transition, $injector) {
    ...
    return {
      ...
      messageBox: function(title, message, buttons, fade){
          var showFade = false;
          if (fade) {
              showFade = true;
          }
        return new Dialog({templateUrl: 'template/dialog/message.html', controller: 'MessageBoxController', dialogFade:showFade, backdropFade:showFade, resolve:
          {model: function() {
            return {
              title: title,
              message: message,
